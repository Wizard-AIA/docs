...
const securityFeatures = [
  {
    icon: Shield,
    title: "Static code guard",
    description: "An AST policy check rejects restricted imports and dynamic execution before anything runs.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "OS-native containment",
    description: "Landlock + seccomp, sandbox-exec, or a Windows Job Object — writes confined, network denied.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Container isolation",
    description: "Opt into Docker for cap_drop=ALL, no-new-privileges and per-execution timeouts.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Scoped filesystem",
    description: "Each session reads and writes only its own workspace directory.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["AST guard", "OS sandbox", "Container", "Scoped FS"];
    ...
    <section id="security" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          {/* Title — full width */}
          <h2 className={`text-[clamp(2.2rem,6vw,7.5rem)] font-display tracking-tight leading-[0.92] mb-8 sm:mb-12 transition-all duration-1000 ${
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Verify it, don&apos;t trust it</span>
              <div className="mt-8">
                <span className="text-7xl lg:text-8xl font-display">4</span>
                <span className="block text-muted-foreground mt-2">layers before code touches your files</span>
              </div>
            </div>
