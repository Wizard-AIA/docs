...
const steps = [
  {
    ...
    title: "Upload",
    subtitle: "or connect",
    description: "CSV, TSV, Excel, JSON, NDJSON, Parquet or Feather — or connect a database. Attach reference documents so the agent knows what a column actually means.",
...
tables['customers']`,
  },
  {
    number: "02",
    title: "Ask",
    subtitle: "a real question",
    description: "A manager model decides what to do next from real execution output; a worker model writes the Python. It repeats until it has an answer or runs out of budget.",
    code: `WS /ws/chat
reasoning_delta → "check the join key"
code             → df.merge(...)
stdout           → 1,204 unmatched rows`,
  },
  {
    number: "03",
    title: "Verify",
    subtitle: "the answer",
    description: "The headline result is recomputed a different way. Dropped nulls, inner joins, top-N cuts — read back out of the code that actually ran, not its description of it.",
    code: `GET /api/report

# every analysis also exports as
# a runnable script`,
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-[clamp(2.5rem,7vw,7.5rem)] font-display tracking-tight leading-[0.88] transition-all duration-1000 delay-100 ${
