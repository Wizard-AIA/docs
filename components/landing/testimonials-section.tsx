...
const testimonials = [
  {
    quote: "Two small Ollama models are enough to be useful. Nothing is sent anywhere.",
    author: "Wizard",
    role: "Local-first",
    company: "README.md",
    metric: { value: "0 KB", label: "sent anywhere by default" },
  },
  {
    quote: "The headline result is recomputed by a different route, and any figure that appears in no execution output is flagged rather than quietly presented.",
    author: "Wizard",
    role: "Self-verifying",
    company: "README.md",
    metric: { value: "2x", label: "computed, then verified" },
  },
  {
    quote: "A 1.5B model gets a short leash and deterministic fallbacks; a large model gets a long investigation. Same app, one setting.",
    author: "Wizard",
    role: "Sizes to your hardware",
    company: "README.md",
    metric: { value: "auto", label: "tier selection" },
  },
  {
    quote: "Docker is optional, not a fallback. Without it, code runs in a subprocess per session — its own memory ceiling, a per-step timeout, a working Stop button.",
    author: "Wizard",
    role: "Docker is optional",
    company: "README.md",
    metric: { value: "3", label: "execution backends" },
  },
];
...
export function TestimonialsSection() {
  ...
  // Generated only after mount -- Math.random() during SSR would render
  // different text on the server and the client and fail hydration.
  useEffect(() => {
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              In the project&apos;s
              <span className="text-background/40"> own words.</span>
            </h2>
          </div>
