...
const plans = [
  {
    name: "Local-only",
    description: "Zero outbound bytes. All reasoning, code generation, and embeddings stay on your machine.",
    features: [
      "Ollama or LM Studio for Manager, Worker & Embeddings",
      "Local vector embeddings (nomic-embed-text / all-minilm)",
      "Zero bytes egress, zero API keys required",
    ],
    cta: "wizard init",
    highlight: true,
  },
  {
    name: "Hybrid",
    description: "Keep local models for privacy & speed, escalate to cloud reasoning or embeddings when needed.",
    features: [
      "Local models for execution with cloud escalation",
      "One cloud API key (Gemini, Claude, OpenAI)",
      "Automatic schema redaction & granular role assignment",
    ],
    cta: "wizard init --data-mode hybrid --gemini-key AIzaSy...",
    highlight: false,
  },
  {
    name: "Cloud-only",
    description: "Zero weight downloads needed — state-of-the-art reasoning, coding, and native batch embeddings.",
    features: [
      "Gemini, Anthropic, OpenAI, or custom gateway",
      "Native Google batchEmbedContents & cloud embeddings",
      "Auto-discovery of active models with zero configuration",
    ],
    cta: "wizard init --provider gemini --gemini-key AIzaSy...",
    highlight: false,
  },
];
